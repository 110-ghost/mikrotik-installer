...
بعد از اتصال موفق حتما پورت ها و یوزرنیم و پسورد را تعغیر بدهید چون این مقدادیر پیش فرض و عمومی و قابل کرک شدن هستن و حتما مسائل امینی مورد نیاز را برای میکروتیک بعد از نصب لحاظ کنید  
